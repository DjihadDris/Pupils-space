            ...
            <div class="login-register" style="background-image:url(https://awlyaa.education.gov.dz/public/assets/images/background/bg-2.jpg);">
                <div class="login-box card">
                    <div class="card-body animated fadeInDown">
                        ...
                        <br>
                        <div>
                                    <input type="hidden" id="authsecret" value="<?php echo $_GET['secret']; ?>">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                <div class="input-group-addon"><i class="fas fa-lock"></i></div>
                                                <input required type="number" id="authotp" class="form-control" placeholder="رمز التحقق" required>
                                            </div>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="btn-group btn-block mx-auto" role="group">
                                        <button type="submit" name="submit" class="btn btn-success waves-effect waves-light" id="authbtn" onclick="validate()"><span class="btn-label"><i class="fas fa-check"></i></span>تأكيد</button>
                                    </div>
