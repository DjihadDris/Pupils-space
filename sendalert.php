...
$req_data = array(
    'title' 		=> $name." - ".$subject." - ".$year, //required
    'message' 		=> "ثانوية صولاج السعيد: فضاء التلاميذ", //required
    'target_url'	=> 'https://souledj.epizy.com/subject?id='.$subject, //required

    //following parameters are optional
    //'name'		=> 'Test campaign',
    'icon'		=> 'https://souledj.epizy.com/favicon.png'
